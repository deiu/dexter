...
const FinancialMetricsInputSchema = z.object({
  ...
  report_period: z
    ...
    .optional()
    .describe(
      "Filter for financial metrics with an exact report period date (YYYY-MM-DD).",
    ),
  report_period_gt: z
    .string()
    .nullable()
    .optional()
    .describe(
      "Filter for financial metrics with report periods after this date (YYYY-MM-DD).",
    ),
  report_period_gte: z
    .string()
    .nullable()
  ...
  report_period_lt: z
    ...
    .optional()
    .describe(
      "Filter for financial metrics with report periods before this date (YYYY-MM-DD).",
    ),
  report_period_lte: z
    .string()
    .nullable()
