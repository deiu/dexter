...
const FinancialStatementsInputSchema = z.object({
  ...
  report_period_gt: z
    ...
    .optional()
    .describe(
      "Filter for financial statements with report periods after this date (YYYY-MM-DD).",
    ),
  report_period_gte: z
    .string()
    .nullable()
  ...
  report_period_lt: z
    ...
    .optional()
    .describe(
      "Filter for financial statements with report periods before this date (YYYY-MM-DD).",
    ),
  report_period_lte: z
    .string()
    .nullable()
